    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex justify-center items-center">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl max-w-[950px] w-[90%] grid md:grid-cols-2 overflow-hidden shadow-lg relative z-10"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          {/* Left Section */}
          <div className="hidden md:flex relative p-4 flex-col items-center">
            {/* <img
              src={CreatePlanImg}
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${CreatePlanImg})`,
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full h-[48px] border border-neutral_stroke_1 rounded-xl px-4 py-2 text-16 font-albra_sans_r text-brand_secondary focus:outline-none focus:ring-2 focus:ring-brand_primary"
                >
...
export default CreateYourPlanModal;
