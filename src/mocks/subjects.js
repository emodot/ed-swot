...
export const subjects = [
  {
    ...
    prepares: "📌 Prepares for: SATs (UK Primary), 11+, GCSE Maths, A-Level Maths, AP Calculus, SAT/ACT (US).",
    img: Subject7,
  ...
  },
  {
    ...
    prepares: "📌 Prepares for: KS3 Science (UK), Middle School Science (US), and GCSE.",
    img: Subject1,
    tutor: "Multiple Tutors",
  },

  {
    ...
    prepares: "📌 Prepares for: GCSE, A-Level Sciences, AP Science Courses, SAT Subject Tests (when applicable).",
    img: Subject3,
    tutor: "Multiple Tutors",
  },
  {
    ...
    prepares: "📌 Prepares for: SATs (UK), 11+, GCSE English Language & Literature, A-Level English, SAT Reading/Writing, ACT English, AP English Literature/Language.",
    img: Subject2,
    tutor: "Multiple Tutors",
  },
  {
    ...
    prepares: "📌 Prepares for: GCSE & A-Level Computer Science, AP Computer Science, SAT/ACT problem-solving, coding bootcamps, and real-world projects.",
    img: Subject9,
    tutor: "Multiple Tutors",
  },
  {
    title: "Languages (Yoruba, Igbo, Hausa,French, etc.)",
    desc: "For children and adults, our language courses build communication competence—from beginner conversation to advanced reading and writing—while deepening cultural awareness.",
    prepares: "📌 Prepares for:  Heritage language mastery for Yoruba, Igbo, and Hausa, and GCSE French & other MFLs, A-Level French, AP French, SAT Subject Test (French).",
    img: Subject10,
    tutor: "Multiple Tutors",
  },
  // {
